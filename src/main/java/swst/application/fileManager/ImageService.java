package swst.application.fileManager;
...
public class ImageService implements FileStorageServices {
	...
	public Resource load(String filename) {
		try {
			...
			if (reso.exists() || reso.isReadable()) {
				...
				throw new ExceptionFoundation(ExceptionresponsesModel.EXCEPTION_CODES.SEARCH_CAN_NOT_READ,
	...
	public Stream<Path> loadAll() throws ExceptionFoundation {
		throw new ExceptionFoundation(ExceptionresponsesModel.EXCEPTION_CODES.FEATURE_NOT_IMPLEMENTED,
				"[ NOT IMPLEMENTED ] This feature is currently unavailable.");
	}

	@Override
	public void purgeFiles() throws ExceptionFoundation {
		throw new ExceptionFoundation(ExceptionresponsesModel.EXCEPTION_CODES.FEATURE_TOO_DANGEROUS_TO_HAVE_IT,
